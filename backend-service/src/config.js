export function loadConfig(env = process.env) {
  return {
    ...
    binancePaySecretKey: env.BINANCE_PAY_SECRET_KEY || "",
    binancePayBaseUrl: env.BINANCE_PAY_BASE_URL || "https://bpay.binanceapi.com",
    binancePayWebhookSecret: env.BINANCE_PAY_WEBHOOK_SECRET || "",
